...
no: {
  ...
  ord_s4_upload_hint: 'JPG, PNG, GIF, WebP, MP4, MOV, AVI, M4A, MP3, WAV, AAC · maks 1 GB totalt · maks 10 filer',
  ord_s4_upload_message_label: 'Legg til en personlig hilsen',
  ord_s4_upload_message_optional: '(valgfritt)',
  ord_s4_audio_title: 'Eller spill inn en hilsen',
  ord_s4_audio_hint: 'Maks 5 minutter',
  ord_s4_audio_start: 'Spill inn tale',
  ord_s4_audio_stop: 'Stopp opptak',
  ord_s4_audio_retry: 'Spill inn på nytt',
  ord_s4_audio_keep: 'Behold opptak',
  ...
  ord_s4_err_filetype: 'Noen filer ble avvist. Tillatte formater: JPG, PNG, GIF, WebP, MP4, MOV, AVI, M4A, MP3, WAV, AAC.',
  ...
  ord_s5_plan_title: 'Hvordan vil du betale?',
  ord_s5_plan_full_title: 'Betal alt nå',
  ord_s5_plan_full_desc: 'Én betaling – ferdig med det.',
  ord_s5_plan_yearly_title: 'Årlig nedbetaling',
  ord_s5_plan_yearly_desc: 'Startpris nå, så en liten sum automatisk hvert år til brevet leveres.',
  ord_s5_plan_yearly_unavailable: 'Årlig nedbetaling er kun mulig når brevet skal leveres om minst ett år.',
  ord_s5_plan_now: 'nå',
  ord_s5_plan_year_suffix: '/år',
  ord_s5_plan_total: 'totalt',
...
en: {
  ...
  ord_s4_upload_hint: 'JPG, PNG, GIF, WebP, MP4, MOV, AVI, M4A, MP3, WAV, AAC · max 1 GB total · max 10 files',
  ord_s4_upload_message_label: 'Add a personal greeting',
  ord_s4_upload_message_optional: '(optional)',
  ord_s4_audio_title: 'Or record a greeting',
  ord_s4_audio_hint: 'Max 5 minutes',
  ord_s4_audio_start: 'Record voice',
  ord_s4_audio_stop: 'Stop recording',
  ord_s4_audio_retry: 'Record again',
  ord_s4_audio_keep: 'Keep recording',
  ...
  ord_s4_err_filetype: 'Some files were rejected. Accepted formats: JPG, PNG, GIF, WebP, MP4, MOV, AVI, M4A, MP3, WAV, AAC.',
  ...
  ord_s5_plan_title: 'How would you like to pay?',
  ord_s5_plan_full_title: 'Pay in full now',
  ord_s5_plan_full_desc: 'One payment — all done.',
  ord_s5_plan_yearly_title: 'Pay yearly',
  ord_s5_plan_yearly_desc: 'Start price now, then a small amount automatically each year until your letter is delivered.',
  ord_s5_plan_yearly_unavailable: 'Yearly instalments are only available when the letter is delivered at least a year from now.',
  ord_s5_plan_now: 'now',
  ord_s5_plan_year_suffix: '/yr',
  ord_s5_plan_total: 'total',
